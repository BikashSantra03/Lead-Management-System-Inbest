...
| PUT    | `/auth/update-password`  | `Content-Type: application/json`<br>`Authorization: Bearer <token>` | `json<br>{<br>  "currentPassword": "password123",<br>  "newPassword": "newpassword456"<br>}<br>`                                              |
